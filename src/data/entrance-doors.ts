...
export const ENTRANCE_SKINS: EntranceSkin[] = [
  ...
  { id: 'maxi-mirror-ice',              name: 'MAXI Mirror',  color: 'Ice',                glassColor: 'Зеркало', photo: 'https://storage.yandexcloud.net/vfd74ru/metal_doors/BalanceTwin/maxi_mirror.webp' },

  { id: 'sektor',                       name: 'Сектор',       color: '',                   photo: 'https://storage.yandexcloud.net/vfd74ru/metal_doors/BalanceDuo/nakladka_sektor.webp' },
]
...
export interface EntranceDoorModel {
  ...
  /** Бейдж "Хит" на карточке/hero — самая популярная модель */
  isHit?:      boolean
}

const OPTIMA_CDN = `${CDN}Optima/`

/** Общие характеристики/фурнитура для линейки Баланс (Твин, Дуо — одна платформа) */
const BALANCE_SPECS: EntranceDoorSpec[] = [
  { label: 'Тип двери',                       value: 'Квартирная входная дверь, для эксплуатации в подъезде' },
  { label: 'Отделка снаружи',                  value: 'Стальной лист в порошковой окраске' },
  { label: 'Цвет',                             value: 'Букле Чёрный' },
  { label: 'Отделка внутри',                   value: 'Декоративная панель MDF от 12 мм с отделкой PVC/PP' },
  { label: 'Толщина дверного полотна',         value: '102 мм' },
  { label: 'Толщина стали полотна',            value: '1,5 мм' },
  { label: 'Толщина стали короба',              value: '1,7 мм' },
  { label: 'Размер дверного блока по коробке', value: '2050×960 мм, 2050×860 мм' },
  { label: 'Тип короба',                       value: 'Открытый' },
  { label: 'Толщина короба',                   value: '117 мм' },
  { label: 'Вес дверного блока',                value: '90 кг' },
  { label: 'Порог',                             value: 'Нержавеющая сталь (дополнительная опция)' },
  { label: 'Уплотнение',                       value: 'Три контура уплотнителя. На полотне — Schlegel (2 контура). На коробе — EPDM (1 контур)' },
  { label: 'Открывание',                       value: '180°' },
  { label: 'Утепление',                        value: 'Комбинированное: минеральная плита «Технониколь» (50 мм) + панель пенополистирола XPS (30 мм)' },
...
const BALANCE_HARDWARE: string[] = [
  ...
  'Ночная задвижка',
  'Цилиндровая вставка ключ-шток-вертушок',
  'Броненакладка',
...
export const ENTRANCE_DOOR_MODELS: EntranceDoorModel[] = [
  ...
  },
  {
    id:          'ekspertnext',
    name:        'ЭкспертНекст',
    tagline:     'Квартирная входная дверь повышенной защиты',
    description: 'Стальное полотно 102 мм с комбинированным утеплением (минплита + XPS), замки Гардиан 3 и 4 класса защиты, три контура уплотнения — усиленная дверь для квартиры.',
    coverImage:  `${CDN}Next/render_expert_next.webp`,
    doorImage:   `${CDN}Next/expert_next.webp`,
    specs: [
      { label: 'Тип двери',              value: 'Квартирная входная дверь, для эксплуатации в подъезде' },
      { label: 'Назначение',             value: 'Для квартиры' },
      { label: 'Толщина металла',        value: '1,4 мм' },
    ...
    skinOptions: [
      { skinId: 'niuta-ice',                  price: 36_500 },
      { skinId: 'niuta-steel',                price: 36_500 },
      { skinId: 'niuta-onyx',                 price: 36_500 },
      { skinId: 'niuta-taupe',                price: 36_500 },
      { skinId: 'niuta-midwhite',             price: 36_500 },
      { skinId: 'er1-ice',                    price: 36_500 },
      { skinId: 'er1-onyx',                   price: 36_500 },
      { skinId: 'er2-steel',                  price: 36_500 },
      { skinId: 'er2-taupe',                  price: 36_500 },
      { skinId: 'glanta-ice',                 price: 36_500 },
      { skinId: 'glanta-onyx',                price: 36_500 },
      { skinId: 'dorren-ice',                 price: 36_500 },
      { skinId: 'dorren-midwhite',            price: 36_500 },
      { skinId: 'atumpro33-dub-arktik',       price: 35_700 },
      { skinId: 'atumpro33-dub-kamenny',      price: 35_700 },
      { skinId: 'e33-ice',                    price: 36_500 },
      { skinId: 'e33-taupe',                  price: 36_500 },
      { skinId: 'e33-onyx',                   price: 36_500 },
      { skinId: 'graphica-vr-ice',            price: 36_500 },
      { skinId: 'graphica-vr-beton-svetly',   price: 35_700 },
      { skinId: 'graphica-vr-beton-temny',    price: 35_700 },
      { skinId: 'atum5-snezhny',              price: 35_700 },
      { skinId: 'atum5-belenyi-dub',          price: 35_700 },
      { skinId: 'atum5-kapuchino',            price: 35_700 },
      { skinId: 'atum5-dub-sery',             price: 35_700 },
      { skinId: 'atumpro32-dub-kamenny',      price: 35_700 },
      { skinId: 'atumpro28-dub-arktik',       price: 35_700 },
      { skinId: 'atumpro28-dub-kamenny',      price: 35_700 },
      { skinId: 'atumpro28-dub-krasny',       price: 35_700 },
      { skinId: 'atumpro28-dub-skandinavsky', price: 35_700 },
      { skinId: 'atumpro28-beton-svetly',     price: 35_700 },
      { skinId: 'atumpro26-dub-arktik',       price: 35_700 },
      { skinId: 'atum6-belenyi-dub',          price: 35_700 },
      { skinId: 'atum6-kapuchino',            price: 35_700 },
      { skinId: 'atum6-venge',                price: 35_700 },
      { skinId: 'niuta-dub-tehas',            price: 35_700 },
    ],
  },
  {
    id:          'ekspertlt',
    name:        'ЭкспертЛТ',
    tagline:     'Квартирная входная дверь с открытым коробом',
    description: 'Стальное полотно 100 мм со штамповкой внутрь, металлический порог, три контура уплотнения — облегчённая дверь для квартиры в подъезде.',
    coverImage:  `${CDN}ExpertLT/render_expert.webp`,
    doorImage:   `${CDN}ExpertLT/expert_lt.webp`,
    specs: [
      { label: 'Тип двери',                       value: 'Квартирная входная дверь, для эксплуатации в подъезде' },
      { label: 'Отделка снаружи',                  value: 'Стальной лист с декоративной штамповкой внутрь в порошковой окраске' },
      { label: 'Цвет',                             value: 'Букле Графит' },
      { label: 'Отделка внутри',                   value: 'Декоративная панель MDF от 10–16 мм с отделкой PVC/PP' },
      { label: 'Толщина дверного полотна',         value: '100 мм' },
      { label: 'Толщина стали полотна',            value: '1,2 мм' },
      { label: 'Толщина стали короба',              value: '1,4 мм' },
      { label: 'Размер дверного блока по коробке', value: '2050×960 мм, 2050×860 мм' },
      { label: 'Тип короба',                       value: 'Открытый' },
      { label: 'Толщина короба',                   value: '117 мм' },
      { label: 'Вес дверного блока',                value: '80 кг' },
      { label: 'Порог',                             value: 'Металлический' },
      { label: 'Уплотнение',                       value: 'Три контура' },
      { label: 'Открывание',                       value: '180°' },
      { label: 'Утепление',                        value: 'Пенополистирол' },
      { label: 'Количество петель',                value: '3 петли' },
    ...
    skinOptions: [
      { skinId: 'niuta-ice',                  price: 28_600 },
      { skinId: 'niuta-steel',                price: 28_600 },
      { skinId: 'niuta-onyx',                 price: 28_600 },
      { skinId: 'niuta-taupe',                price: 28_600 },
      { skinId: 'niuta-midwhite',             price: 28_600 },
      { skinId: 'er1-ice',                    price: 28_600 },
      { skinId: 'er1-onyx',                   price: 28_600 },
      { skinId: 'er2-steel',                  price: 28_600 },
      { skinId: 'er2-taupe',                  price: 28_600 },
      { skinId: 'glanta-ice',                 price: 28_600 },
      { skinId: 'glanta-onyx',                price: 28_600 },
      { skinId: 'dorren-ice',                 price: 28_600 },
      { skinId: 'dorren-midwhite',            price: 28_600 },
      { skinId: 'atumpro33-dub-arktik',       price: 27_800 },
      { skinId: 'atumpro33-dub-kamenny',      price: 27_800 },
      { skinId: 'e33-ice',                    price: 28_600 },
      { skinId: 'e33-taupe',                  price: 28_600 },
      { skinId: 'e33-onyx',                   price: 28_600 },
      { skinId: 'graphica-vr-ice',            price: 28_600 },
      { skinId: 'graphica-vr-beton-svetly',   price: 27_800 },
      { skinId: 'graphica-vr-beton-temny',    price: 27_800 },
      { skinId: 'atum5-snezhny',              price: 27_800 },
      { skinId: 'atum5-belenyi-dub',          price: 27_800 },
      { skinId: 'atum5-kapuchino',            price: 27_800 },
      { skinId: 'atum5-dub-sery',             price: 27_800 },
      ...
      { skinId: 'atumpro28-dub-kamenny',      price: 27_800 },
      { skinId: 'atumpro28-dub-krasny',       price: 27_800 },
      { skinId: 'atumpro28-dub-skandinavsky', price: 27_800 },
      { skinId: 'atumpro28-beton-svetly',     price: 27_800 },
      { skinId: 'atumpro26-dub-arktik',       price: 27_800 },
      { skinId: 'atum6-belenyi-dub',          price: 27_800 },
      { skinId: 'atum6-kapuchino',            price: 27_800 },
      { skinId: 'atum6-venge',                price: 27_800 },
      { skinId: 'niuta-dub-tehas',            price: 27_800 },
    ],
  },
  {
    id:          'balancetwin',
    ...
    description: 'Стальное полотно 102 мм с комбинированным утеплением (минплита + XPS), усиленная сталь короба 1,7 мм, три контура уплотнения — самая популярная модель.',
    coverImage:  `${CDN}BalanceTwin/render_balance_twin.webp`,
    doorImage:   `${CDN}BalanceTwin/balance_twin.webp`,
    isHit:       true,
    specs:    BALANCE_SPECS,
    hardware: BALANCE_HARDWARE,
    skinOptions: [
      { skinId: 'maxi-mirror-ice',            price: 41_300 },
      { skinId: 'niuta-ice',                  price: 39_100 },
      { skinId: 'niuta-steel',                price: 39_100 },
      { skinId: 'niuta-onyx',                 price: 39_100 },
      { skinId: 'niuta-taupe',                price: 39_100 },
      { skinId: 'niuta-midwhite',             price: 39_100 },
      { skinId: 'er1-ice',                    price: 39_100 },
      { skinId: 'er1-onyx',                   price: 39_100 },
      { skinId: 'er2-steel',                  price: 39_100 },
      { skinId: 'er2-taupe',                  price: 39_100 },
      { skinId: 'glanta-ice',                 price: 39_100 },
      { skinId: 'glanta-onyx',                price: 39_100 },
      { skinId: 'dorren-ice',                 price: 39_100 },
      { skinId: 'dorren-midwhite',            price: 39_100 },
      { skinId: 'atumpro33-dub-arktik',       price: 38_300 },
      { skinId: 'atumpro33-dub-kamenny',      price: 38_300 },
      { skinId: 'e33-ice',                    price: 39_100 },
      { skinId: 'e33-taupe',                  price: 39_100 },
      { skinId: 'e33-onyx',                   price: 39_100 },
      { skinId: 'graphica-vr-ice',            price: 39_100 },
      { skinId: 'graphica-vr-beton-svetly',   price: 38_300 },
      { skinId: 'graphica-vr-beton-temny',    price: 38_300 },
      { skinId: 'atum5-snezhny',              price: 38_300 },
      { skinId: 'atum5-belenyi-dub',          price: 38_300 },
      { skinId: 'atum5-kapuchino',            price: 38_300 },
      { skinId: 'atum5-dub-sery',             price: 38_300 },
      { skinId: 'atumpro32-dub-kamenny',      price: 38_300 },
      { skinId: 'atumpro28-dub-arktik',       price: 38_300 },
      { skinId: 'atumpro28-dub-kamenny',      price: 38_300 },
      { skinId: 'atumpro28-dub-krasny',       price: 38_300 },
      { skinId: 'atumpro28-dub-skandinavsky', price: 38_300 },
      { skinId: 'atumpro28-beton-svetly',     price: 38_300 },
      { skinId: 'atumpro26-dub-arktik',       price: 38_300 },
      { skinId: 'atum6-belenyi-dub',          price: 38_300 },
      { skinId: 'atum6-kapuchino',            price: 38_300 },
      { skinId: 'atum6-venge',                price: 38_300 },
      { skinId: 'niuta-dub-tehas',            price: 38_300 },
    ],
  },
  {
    id:          'balanceduo',
    name:        'БалансДуо',
    tagline:     'Отличное сочетание качества сборки, дизайна и звукоизоляции',
    description: 'Стальное полотно 102 мм с комбинированным утеплением (минплита + XPS), усиленная сталь короба 1,7 мм, три контура уплотнения — вторая модель линейки Баланс.',
    ...
    hardware: BALANCE_HARDWARE,
    skinOptions: [
      { skinId: 'niuta-ice',                  price: 40_200 },
      { skinId: 'niuta-steel',                price: 40_200 },
      { skinId: 'niuta-onyx',                 price: 40_200 },
      { skinId: 'niuta-taupe',                price: 40_200 },
      { skinId: 'niuta-midwhite',             price: 40_200 },
      { skinId: 'niuta-dub-tehas',            price: 39_500 },
      { skinId: 'glanta-ice',                 price: 40_200 },
      { skinId: 'glanta-onyx',                price: 40_200 },
      { skinId: 'dorren-ice',                 price: 40_200 },
      { skinId: 'stockholm-ice',              price: 40_200 },
      { skinId: 'er1-ice',                    price: 40_200 },
      { skinId: 'er1-onyx',                   price: 40_200 },
      { skinId: 'er2-steel',                  price: 40_200 },
      { skinId: 'er2-taupe',                  price: 40_200 },
      { skinId: 'e33-ice',                    price: 40_200 },
      { skinId: 'e33-taupe',                  price: 40_200 },
      { skinId: 'atumpro33-dub-arktik',       price: 39_500 },
      { skinId: 'atumpro33-dub-kamenny',      price: 39_500 },
      { skinId: 'atumpro28-dub-kamenny',      price: 39_500 },
      { skinId: 'atumpro28-dub-arktik',       price: 39_500 },
      { skinId: 'atumpro28-beton-svetly',     price: 39_500 },
      { skinId: 'atumpro28-dub-krasny',       price: 39_500 },
      { skinId: 'atumpro28-dub-skandinavsky', price: 39_500 },
      { skinId: 'atumpro26-dub-arktik',       price: 39_500 },
      { skinId: 'atum5-belenyi-dub',          price: 39_500 },
      { skinId: 'atum5-snezhny',              price: 39_500 },
      { skinId: 'atum5-kapuchino',            price: 39_500 },
      { skinId: 'atum5-dub-sery',             price: 39_500 },
      { skinId: 'atumpro32-dub-kamenny',      price: 39_500 },
