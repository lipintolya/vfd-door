...
export const ENTRANCE_SKINS: EntranceSkin[] = [
  ...
  { id: 'richmond-white',               name: 'Richmond',     color: 'Белый',              photo: 'https://storage.yandexcloud.net/vfd74ru/metal_doors/Termo/Richmond/tl_richmond_vn.webp' },
]
...
export interface EntranceDoorModel {
  ...
  /** Для кого дверь — подъездная квартирная или уличная с терморазрывом.
      Управляет фильтром "Для квартиры / Для дома" в каталоге на странице. */
  purpose:     'apartment' | 'house'
...
export const ENTRANCE_DOOR_MODELS: EntranceDoorModel[] = [
  ...
  },
  {
    id:          'comforttermo',
    name:        'КомфортТермо',
    tagline:     'Уличная входная дверь с терморазрывом',
    description: 'Термомост по периметру полотна и короба, комбинированный утеплитель XPS + ДВП, три контура EPDM-уплотнения — для входа в частный дом, где одна сторона двери на улице.',
    purpose:     'house',
    coverImage:  `${CDN}Termo/ComfortTermo/render_confort_termo.webp`,
    doorImage:   `${CDN}Termo/ComfortTermo/comfort_termo.webp`,
    specs: [
      { label: 'Тип двери',                       value: 'Уличная входная дверь с терморазрывом' },
      { label: 'Отделка снаружи',                  value: 'Стальной лист в порошково-полимерной атмосферостойкой покраске' },
      { label: 'Цвет',                             value: 'Букле графит' },
      { label: 'Отделка внутри',                   value: 'Декоративная панель MDF от 12 мм с отделкой PVC/PP' },
      { label: 'Толщина дверного полотна',         value: '110 мм' },
      { label: 'Толщина стали полотна',            value: '1,5 мм' },
      { label: 'Толщина стали короба',              value: '1,7 мм' },
      { label: 'Размер дверного блока по коробке', value: '2050×960 мм, 2050×860 мм' },
      { label: 'Тип короба',                       value: 'Открытый, двухсоставной, с терморазрывом' },
      { label: 'Толщина короба',                   value: '150 мм' },
      { label: 'Вес дверного блока',                value: '95 кг' },
      { label: 'Порог',                             value: 'Нержавеющая сталь (дополнительная опция)' },
      { label: 'Уплотнение',                       value: 'Три контура высококачественного EPDM-уплотнителя' },
      { label: 'Открывание',                       value: '180°' },
      { label: 'Утепление',                        value: 'Терморазрыв (термомост) из пластика по периметру полотна толщиной 10 мм и между внутренним и наружным профилями коробки — 25 мм. Наполнение полотна — теплоизоляционный сэндвич из панели пенополистирола (XPS) и древесноволокнистой плиты' },
      { label: 'Количество петель',                value: '3 петли' },
    ],
    hardware: [
      'Замок нижний — Галеон 816, цилиндровый с термоштоком, 4 класс защиты',
      'Замок верхний — Галеон 817, сувальдный, 4 класс защиты',
      'Ночная задвижка',
      'Декоративная накладка с металлическими шторками',
    ],
    skinOptions: [
      { skinId: 'niuta-ice',                  price: 42_660 },
      { skinId: 'niuta-steel',                price: 42_660 },
      { skinId: 'niuta-onyx',                 price: 42_660 },
      { skinId: 'niuta-taupe',                price: 42_660 },
      { skinId: 'niuta-midwhite',             price: 42_660 },
      { skinId: 'stockholm-ice',              price: 42_660 },
      { skinId: 'er1-ice',                    price: 42_660 },
      { skinId: 'er1-onyx',                   price: 42_660 },
      { skinId: 'er2-steel',                  price: 42_660 },
      { skinId: 'er2-taupe',                  price: 42_660 },
      { skinId: 'glanta-ice',                 price: 42_660 },
      { skinId: 'glanta-onyx',                price: 42_660 },
      { skinId: 'dorren-ice',                 price: 42_660 },
      { skinId: 'dorren-midwhite',            price: 42_660 },
      { skinId: 'atumpro33-dub-arktik',       price: 42_000 },
      { skinId: 'atumpro33-dub-kamenny',      price: 42_000 },
      { skinId: 'e33-ice',                    price: 42_660 },
      { skinId: 'e33-taupe',                  price: 42_660 },
      { skinId: 'e33-onyx',                   price: 42_660 },
      { skinId: 'graphica-vr-ice',            price: 42_660 },
      { skinId: 'graphica-vr-beton-svetly',   price: 42_000 },
      { skinId: 'graphica-vr-beton-temny',    price: 42_000 },
      { skinId: 'atum5-snezhny',              price: 42_000 },
      { skinId: 'atum5-belenyi-dub',          price: 42_000 },
      { skinId: 'atum5-kapuchino',            price: 42_000 },
      { skinId: 'atum5-dub-sery',             price: 42_000 },
      { skinId: 'atumpro32-dub-kamenny',      price: 42_000 },
      { skinId: 'atumpro28-dub-arktik',       price: 42_000 },
      { skinId: 'atumpro28-dub-kamenny',      price: 42_000 },
      { skinId: 'atumpro28-dub-krasny',       price: 42_000 },
      { skinId: 'atumpro28-dub-skandinavsky', price: 42_000 },
      { skinId: 'atumpro28-beton-svetly',     price: 42_000 },
      { skinId: 'atumpro26-dub-arktik',       price: 42_000 },
      { skinId: 'atum6-belenyi-dub',          price: 42_000 },
      { skinId: 'atum6-kapuchino',            price: 42_000 },
      { skinId: 'atum6-venge',                price: 42_000 },
      { skinId: 'niuta-dub-tehas',            price: 42_000 },
    ],
  },
  {
    id:          'strongtermo',
    name:        'СтронгТермо',
    tagline:     'Уличная входная дверь с терморазрывом',
    description: 'Сварная багетная рамка, закрытый утеплённый короб с терморазрывом, утепление пенополистиролом, минплитой и изолоном — усиленная дверь для входа в частный дом.',
    purpose:     'house',
    coverImage:  `${CDN}Termo/StrongTermo/render_strong_termo.webp`,
    doorImage:   `${CDN}Termo/StrongTermo/strong_termo1.webp`,
    specs: [
      { label: 'Тип двери',                       value: 'Уличная входная дверь с терморазрывом' },
      { label: 'Отделка снаружи',                  value: 'Стальной лист со сварной багетной рамкой в порошковой окраске' },
      { label: 'Цвет',                             value: 'Муар коричневый (RAL 8019)' },
      { label: 'Отделка внутри',                   value: 'Декоративная панель MDF от 12 мм с отделкой PVC/PP' },
      { label: 'Толщина дверного полотна',         value: '114–120 мм' },
      { label: 'Толщина стали полотна',            value: '1,5 мм' },
      { label: 'Толщина стали короба',              value: '1,5 мм' },
      { label: 'Размер дверного блока по коробке', value: '2050×960 мм, 2050×860 мм' },
      { label: 'Тип короба',                       value: 'Закрытый утеплённый с терморазрывом' },
      { label: 'Толщина короба',                   value: '130 мм' },
      { label: 'Вес дверного блока',                value: '100 кг' },
      { label: 'Порог',                             value: 'Нержавеющая сталь (дополнительная опция)' },
      { label: 'Уплотнение',                       value: 'Три контура высококачественного уплотнителя' },
      { label: 'Открывание',                       value: '180°' },
      { label: 'Утепление',                        value: 'Пенополистирол, минплита и изолон' },
      { label: 'Количество петель',                value: '3 петли' },
    ],
    hardware: [
      'Замок нижний — Галеон 816, цилиндровый с термоштоком, 4 класс защиты',
    ...
    skinOptions: [
      { skinId: 'niuta-ice',                  price: 56_260 },
      { skinId: 'niuta-steel',                price: 56_260 },
      { skinId: 'niuta-onyx',                 price: 56_260 },
      { skinId: 'niuta-taupe',                price: 56_260 },
      { skinId: 'niuta-midwhite',             price: 56_260 },
      { skinId: 'stockholm-ice',              price: 56_260 },
      { skinId: 'er1-ice',                    price: 56_260 },
      { skinId: 'er1-onyx',                   price: 56_260 },
      { skinId: 'er2-steel',                  price: 56_260 },
      { skinId: 'er2-taupe',                  price: 56_260 },
      { skinId: 'glanta-ice',                 price: 56_260 },
      { skinId: 'glanta-onyx',                price: 56_260 },
      { skinId: 'dorren-ice',                 price: 56_260 },
      { skinId: 'dorren-midwhite',            price: 56_260 },
      { skinId: 'atumpro33-dub-arktik',       price: 55_490 },
      { skinId: 'atumpro33-dub-kamenny',      price: 55_490 },
      { skinId: 'e33-ice',                    price: 56_260 },
      { skinId: 'e33-taupe',                  price: 56_260 },
      { skinId: 'e33-onyx',                   price: 56_260 },
      { skinId: 'graphica-vr-ice',            price: 56_260 },
      { skinId: 'graphica-vr-beton-svetly',   price: 55_490 },
      { skinId: 'graphica-vr-beton-temny',    price: 55_490 },
      { skinId: 'atum5-snezhny',              price: 55_490 },
      { skinId: 'atum5-belenyi-dub',          price: 55_490 },
      { skinId: 'atum5-kapuchino',            price: 55_490 },
      { skinId: 'atum5-dub-sery',             price: 55_490 },
      { skinId: 'atumpro32-dub-kamenny',      price: 55_490 },
      { skinId: 'atumpro28-dub-arktik',       price: 55_490 },
      { skinId: 'atumpro28-dub-kamenny',      price: 55_490 },
      { skinId: 'atumpro28-dub-krasny',       price: 55_490 },
      { skinId: 'atumpro28-dub-skandinavsky', price: 55_490 },
      { skinId: 'atumpro28-beton-svetly',     price: 55_490 },
      { skinId: 'atumpro26-dub-arktik',       price: 55_490 },
      { skinId: 'atum6-belenyi-dub',          price: 55_490 },
      { skinId: 'atum6-kapuchino',            price: 55_490 },
      { skinId: 'atum6-venge',                price: 55_490 },
      { skinId: 'niuta-dub-tehas',            price: 55_490 },
    ],
  },
  {
    id:          'richmondtermo',
    name:        'РичмондТермо',
    tagline:     'Уличная дверь со стеклопакетом и терморазрывом',
    description: 'Энергоэффективный трёхкамерный стеклопакет из закалённого стекла, полиамидный термопрофиль в полотне и коробе, фурнитура матовый хром — уличная дверь с остеклением для частного дома.',
    purpose:     'house',
    coverImage:  `${CDN}Termo/Richmond/render_richmond.webp`,
    doorImage:   `${CDN}Termo/Richmond/tl_richmond.webp`,
    specs: [
      { label: 'Тип двери',                       value: 'Уличная входная дверь с терморазрывом и стеклопакетом' },
      { label: 'Остекление',                       value: 'Энергоэффективный трёхкамерный стеклопакет из закалённого стекла — устойчиво к перепадам температур и механическим воздействиям, высокие тепло- и шумоизоляционные свойства' },
      { label: 'Цвет фурнитуры',                   value: 'Матовый хром' },
      { label: 'Внешняя накладка',                 value: 'Металл, цвет «Букле графит»' },
      { label: 'Внутренняя накладка',              value: 'МДФ 16 мм, цвет белый' },
      { label: 'Толщина дверного полотна',         value: '110 мм' },
      { label: 'Толщина стали полотна',            value: '1,3 мм' },
      { label: 'Размер дверного блока по коробке', value: '2050×960 мм, 2050×860 мм' },
      { label: 'Тип короба',                       value: 'Открытый короб' },
      { label: 'Уплотнение',                       value: 'Три контура уплотнения' },
      { label: 'Утепление',                        value: 'Заполнение полотна комбинированное: пенополистирол + базальтовая плита' },
      { label: 'Терморазрыв',                       value: 'Полиамидное термопрофильное полотно и рама, полиамидный профиль 10 мм' },
      { label: 'Вес дверного блока',                value: '115 кг' },
    ],
    hardware: [
      'Фурнитура цвета матовый хром',
    ],
    skinOptions: [
      { skinId: 'richmond-white', price: 55_350 },
    ],
  },
]
